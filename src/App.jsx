...
export default function App() {
  ...
  const {
    rows, cols, fileName, mappedCount,
    geocoding, geocodeProgress, fileType, error,
    processFile, loadDirect, reset
  } = useGeoData()
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', height: '100vh' }}>
      <header style={{
        ...
        background: 'var(--bg2)', flexShrink: 0, zIndex: 100,
      }}>
      ...
      <div style={{ display: 'flex', flex: 1, overflow: 'hidden' }}>
        <Sidebar
          ...
          onReset={() => { reset(); setResetTrigger(t => t + 1) }}
